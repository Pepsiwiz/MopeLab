...
for i in range (100):
    ...
    Y1 = [round(
        7.9 + 2.1 * X1[i] + 5.3 * X2[i] + 3.0 * X3[i] + 8.1 * X1_kv[i] + 1.0 * X2_kv[i] + 8.4 * X3_kv[i] + 7.2 * X12[i]
        + 0.8 * X13[i] + 2.3 * X23[i] + 6.4 * X123[i] + random.randrange(-10, 10) - 5, 3) for i in range(15)]
    Y2 = [round(
        7.9 + 2.1 * X1[i] + 5.3 * X2[i] + 3.0 * X3[i] + 8.1 * X1_kv[i] + 1.0 * X2_kv[i] + 8.4 * X3_kv[i] + 7.2 * X12[i]
        + 0.8 * X13[i] + 2.3 * X23[i] + 6.4 * X123[i] + random.randrange(-10, 10) - 5, 3) for i in range(15)]
    Y3 = [round(
...
print("\n Кількість рівнянь адекватних оригіналу" + str(adek))
print("Кількість рівнянь неадекватних оригіналу" + str(neadek)